    ...
    <div class="user-container">
        ...
        <div class="top-info">
            ...
            <div>
                ...
                <div>
                    <van-button round block class="edit-info"
                        >编辑信息</van-button
                    >
                </div>
            </div>
                ...
                <p>
                    ...
                    <span
                        >{{
                            ...
                            new Date(userInfo.createTime).getFullYear() -
                            1
                        }}年 (
                        {{ userInfo.createTime | formatDateYM }} 注册)</span
                    >
                </p>
                <p>
                    性别:
        ...
        <div class="base-info">
            <div class="base-info-title">创建的歌单</div>
            <div class="base-info-con">
        ...
        <div class="base-info">
            <div class="base-info-title">收藏的歌单</div>
            <div class="base-info-con">
                <div class="my-song-lists">
                    <div
                        class="my-song-list"
        ...
        <van-button type="danger" block round @click="handleToLogout"
            >退出登录</van-button
        >
    </div>
</template>
