        ...
        <div v-else>
            <div class='banner'>
                <van-swipe class="my-swipe" :autoplay="3000" indicator-color="white">
                    <van-swipe-item v-for='(item, index) in banners' :key='index'><img class='banner-img'
                            :src="item.pic" alt="">
                    </van-swipe-item>
                </van-swipe>
            </div>
            ...
            <div class="new-songs">
                <div class="new-song-item" v-for='(item,index) in newSongList' :key='index'
                    @click='handleToDetail(item.song.id)'>
                    <div class="left-song">
                        <div class="song-name">{{item.name}}</div>
                        <div class="author">
                            <div class="SQ" v-if="item.song.privilege.flag>=60">
                            </div>
                            <span v-for='(item,index) in item.song.artists'>
                                {{item.name}}
                            </span>
